        ...
        success: function (e) {
            ...
            if (e == "QQ") { // 非遊玩時間
                ...
                if (r == "yes") {
                    ...
                    document.cookie = "exam_user_id=" + user_id + "; path=/;"; //將id放入cookie
                    document.cookie = "exam_user_name=" + user_name + "; path=/;";
                    document.cookie = "exam_user_life=" + life + "; path=/;";
                    document.cookie = "exam_user_score=" + score + "; path=/;";
                    document.cookie = "exam_zone_id=" + zone_id + "; path=/;";
                    document.cookie = "exam_zone_name=" + escape(zone_name) + "; path=/;";
                    document.cookie = "exam_current_index=" + current_index + "; path=/;";
                    document.cookie = "exam_status=" + status + "; path=/;";
                    document.cookie = "exam_login_time=" + login_time + "; path=/;";
                    document.cookie = "exam_login_status=" + login_status + "; path=/;";
                    document.cookie = "exam_exchange_life_status=" + exchange_life_status + "; path=/;";
