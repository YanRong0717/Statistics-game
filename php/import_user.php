...
$affectedRows = $conn->exec(
    "LOAD DATA LOCAL INFILE "
        ...
        . " INTO TABLE `$user_table` CHARACTER SET 'UTF8' FIELDS  TERMINATED BY "
...
$sql = "UPDATE `user` SET `user_id` = '0' WHERE `user`.`user_id` = 1";
$statement = $conn->prepare($sql);
$statement->execute();


echo "共新增了 " .  $affectedRows . "筆至 \"$user_table\" 資料表中.\n";
